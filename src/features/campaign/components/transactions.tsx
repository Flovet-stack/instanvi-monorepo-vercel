      ...
      <div className="w-8/12 bg-white border p-6 rounded">
        <div className="flex flex-col space-y-24">
          <div className="flex flex-row space-x-4 mx-32 mt-5">
            <div
              className={'flex flex-row gap-3 rounded basis-1/3 shadow-md p-4'}
            >
              <div
                className={
                  'text-pink-500 bg-pink-100 p-3 justify-center rounded'
                }
              >
                <svg
            ...
            >
              <div
                className={
                  'text-blue-500 bg-blue-100 p-3 justify-center rounded'
                }
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            >
              <div
                className={
                  'text-orange-500 bg-orange-100 p-3 justify-center rounded'
                }
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex flex-row justify-between">
              <div className={'flex gap-5 py-2 w-8/12 justify-center py-1.5'}>
                ...
                <div className="flex grow">
                  <span className="input-group-text flex items-center whitespace-nowrap rounded px-3 py-1.5 text-center">
