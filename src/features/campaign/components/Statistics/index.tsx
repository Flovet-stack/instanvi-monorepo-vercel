        ...
        <div className={'flex gap-2 mt-2'}>
          <div className="border-2 basis-1/4 p-2.5 rounded-lg">
            <div className="flex justify-between">
              ...
              <small
                className={'flex rounded-full px-1 bg-green-100 p-1 h-fit'}
              >
                <svg
          ...
          <div className="border-2 basis-1/4 p-2.5 rounded-lg">
            <div className="flex justify-between">
              <div className={'flex gap-2 mb-4'}>
                <img src="/images/users-solid%202.svg" alt="user-icon" />
          ...
          <div className="border-2 basis-1/4 p-2.5 rounded-lg">
            <div className="flex justify-between">
              ...
              <small className={'flex rounded-full px-1 bg-red-100 p-1 h-fit'}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
