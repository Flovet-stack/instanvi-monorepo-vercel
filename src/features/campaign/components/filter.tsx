                            ...
                            <div className={"flex flex-col p-4"}>
                                ...
                                <div className="flex gap-4">
                                    <div className={"w-6/12"}>
                                        <label htmlFor="from-date" className="block  font-medium leading-6 text-gray-900">
                                            From
                                        </label>
                                    ...
                                    <div className={"w-6/12"}>
                                        <label htmlFor="to-date" className="block  font-medium leading-6 text-gray-900">
                                            To
                                        </label>
                                        <div className="relative mt-2">
                                            <input
                                ...
                                <div className={"flex flex-col py-2"}>
                                    ...
                                    <select name="transaction-type" id="transaction-type" className={"p-2"}>
                                ...
                                <div className={"flex flex-col py-2"}>
                                    <button type="submit" className={"bg-black rounded text-white p-2"}>Apply</button>
                                </div>
