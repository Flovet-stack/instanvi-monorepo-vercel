...
export function AdChannels(): JSX.Element {
  ...
  const handleChannel = (
    ...
    localStorage.setItem(
      'channel',
      JSON.stringify({ ...storage, category: channel })
    );
                ...
                <div className="w-full">
                  ...
                  >
                    <div className="flex">
                      ...
                      />
                      <div className="ml-3">
                        <h6 className="font-semibold text-lg">Web</h6>
                        <p className="text-sm">Web Publishing SEO </p>
                      </div>
                    </div>
                  ...
                  >
                    <div className="flex">
                      ...
                      <div className="ml-3">
                        <h6 className="font-semibold text-lg">OOH and DOOH</h6>
