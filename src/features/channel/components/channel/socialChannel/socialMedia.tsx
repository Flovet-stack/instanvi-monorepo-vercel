                    ...
                    <div className="justify-center flex mt-5 md:mt-5">
                        <div>
                            ...
                            <div className="w-full flex justify-between mt-5">
                                <Link href={"/publisher/channel/advertissementChannel"}><button className="px-8 py-2 mt-5 rounded text-white bg-orange-400" >previous</button></Link>
                                <Link href={"/publisher/channel/socialMedia"}><button className="px-8 py-2 mt-5 rounded " id="button">Proceed</button></Link>
                            </div>
                        </div>
                    </div>
                </div>
