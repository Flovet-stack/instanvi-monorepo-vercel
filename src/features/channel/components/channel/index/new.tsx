        ...
        <div className="body oveflow-y-none pt-10">
            <div className="mx-auto max-w-8xl px-4 sm:px-12 lg:px-12">
                <div className="w-full flex justify-end my-3 flex ">
                    {
                        saveData ? <><button onClick={handleDraft} className="flex px-4 py-2 rounded mr-3 text-white bg-red-800" ><i className="ri-draft-line text-white mr-1"></i>Draft</button></> : <></>
                    }
                    <button className="flex px-4 py-2 rounded" id="button" onClick={handleNew}><i className="ri-add-line text-white mr-1"></i>New Channel</button>
                </div>
                <Table />
            </div>
        </div>
