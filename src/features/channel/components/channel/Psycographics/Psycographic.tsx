    ...
    const [datas] = useState<Psycographics[]>([
        {
            ...
            description: "Get exposure and reach more potential customers. No Engagement or purchases. Efficiency measured on views/clicks"
        },
        {
            id: 2,
            image: "/images/Group 50174.svg",
            title: "Direct Sales (Commissions)",
            description: "I will make sales for a flat Commissions on every sale  with some base  requirements provided."
        },
        {
            id: 3,
            image: "/images/Group 50170.svg",
            title: "Referrals & Collaborations (Commissions)",
            description: "Use my brand to endorse products. Typically involves making customer versions of products to match my brand"
        },
        {
            id: 4,
            image: "/images/Group 50171.svg",
            title: "Application Downloads/Website visits",
            description: "Optimized to drive traffic to Webpage or increase application application downloads. Efficiency measured based on website visits  or application downloads"
        },
        {
            id: 5,
            image: "/images/Group 50172.svg",
            title: "Local Visits",
            description: "Leverage existing audience or potential audience to  drive traffic to your location. Mostly through direct reach, events, social  gatherings etc"
        },
    ])

    const handlePsyco = (e: any) => {
