                ...
                <form className="justify-center flex mt-10" onSubmit={handleSubmit(onSubmitHandler)}>
                    <div className="w-full  md:w-[40%]     md:px-0 px-4">
                        <div className="flex w-full justify-between">
                            <div className="mt-3 w-full">
                                ...
                                <input
                                    ...
                                    placeholder="kevin"
                                />
                                <div><p className="" style={{ color: "rgb(206, 8, 8)", fontSize: "12px" }}>{errors.Firstname?.message}</p></div>
                            </div>
                            <div className="mt-3  w-full">
                                ...
                                />
                                <div><p className="" style={{ color: "rgb(206, 8, 8)", fontSize: "12px" }}>{errors.Lastname?.message}</p></div>
                        ...
                        <div className="mt-3">
                            ...
                            />
                            <div><p className="" style={{ color: "rgb(206, 8, 8)", fontSize: "12px" }}>{errors.CompanyName?.message}</p></div>
                        ...
                        <div className="mt-3">
                            ...
                            <div><p className="" style={{ color: "rgb(206, 8, 8)", fontSize: "12px" }}>{errors.teamSize?.message}</p></div>
