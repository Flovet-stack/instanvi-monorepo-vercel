        ...
        <div className="flex justify-between items-center my-5">
            ...
            <div className="flex gap-4 justify-between items-center">
                <div className="flex border border-gray-500 divide-x divide-black rounded cursor-pointer bg-gray-100">
                    <button
                        className={`flex justify-evenly items-center py-1 px-2 rounded-l ${format == "grid" ? "bg-gray-100 text-green-500" : "bg-white"
                            }`}
                        onClick={() => {
                            setFormat("grid");
                            setShowList(false);
                    ...
                    <button
                        className={`flex justify-evenly items-center py-1 px-2 rounded-r ${format == "list" ? "bg-gray-100 text-green-500" : "bg-white"
                            }`}
                        onClick={() => {
                            setFormat("list");
                            setShowList(true);
