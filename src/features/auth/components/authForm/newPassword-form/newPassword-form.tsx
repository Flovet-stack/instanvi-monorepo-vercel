        ...
        <>
            <div className="w-full">
                ...
                <div className="justify-center flex mt-28 md:mt-48">
                    <form onSubmit={handleSubmit((data) => setData(JSON.stringify(data)))} className="w-full  md:w-[28%] border border-gray-200 bg-white rounded-lg md:px-8 px-4">
                        ...
                        <div className="flex justify-center my-4 pb-5">
                            <input value={"Reset Password"} id='button' type='submit' className="w-full py-2.5 border text-white bg-black border-gray-200 rounded-lg outline-none pl-2  " />
