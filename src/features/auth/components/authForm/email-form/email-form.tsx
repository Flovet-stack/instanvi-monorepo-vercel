...
import { useForgotenPassword } from '@/features/auth/api/email';
...
export const EmailForm = ({
  ...
  const sendCode = useForgotenPassword({ onSuccess })
  // eslint-disable-next-line @typescript-eslint/no-unused-vars

  const { register, handleSubmit, formState: { errors } } = useForm<ForgotPasswordEmailDto>({
