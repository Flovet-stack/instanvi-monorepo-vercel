...
export default function FormMenuList(props: MenuList) {
    const { setGeneral, setMedia, setScheduling, setPricing, scrollToForm } = props
        ...
        <div className="px-4 w-48 mt-3 ml-10">
            <div className="mt-2 fixed">
                <div
                    ...
                    className={`${general ? "border-r-2 border-green-500 text-green-500" : ""
                ...
                <div
                    ...
                    className={`${media ? "border-r-2 border-green-500 text-green-500" : ""
                        }  mt-3 pr-3 text-lg cursor-pointer`}
                >
                    <p>medias</p>
                </div>
                <div
                    ...
                    className={`${scheduling ? "border-r-2 border-green-500 text-green-500" : ""
                        }  mt-3 pr-3 text-lg cursor-pointer`}
                >
                    <p>schedulings</p>
                </div>
                <div
                    ...
                    className={`${pricing ? "border-r-2 border-green-500 text-green-500" : ""}  mt-3 pr-3 text-lg cursor-pointer`}
                >
                    <p>pricing</p>
                </div>
