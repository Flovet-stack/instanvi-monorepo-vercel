                ...
                <div className="w-full border-t-2  flex">
                    ...
                    >
                        <div className={`flex  ${it.id}`}>
                            <div className="flex w-7/8">
                                <Inventory data={{ uuid: 'test', type: 'available', time: '6:00 - 7:00 Am' }} />
                                <Inventory data={{ uuid: 'test', type: 'MTN Cameroon', time: '6:00 - 7:00 Am' }} />
                                <Inventory data={{ uuid: 'test', type: 'available', time: '6:00 - 7:00 Am' }} />
                                <Inventory data={{ uuid: 'test', type: 'pending', time: '6:00 - 7:00 Am' }} />
                                <Inventory data={{ uuid: 'test', type: 'pending', time: '6:00 - 7:00 Am' }} />
                            </div>
                        </div>
                    </div>
                    <div className="w-[100px] border-b border-r flex justify-center h-28">
                        <div className="flex mt-10">
                            <button
                                onClick={() => { handleHorizantalScroll(it.id, 25, 350, -10) }}
