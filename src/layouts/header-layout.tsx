...
export const HeaderLayout = ({
    ...
    return (
        <div className="w-full  ">
            <div className="w-full z-30  fixed border-b ">
                <Popover
                    as="header"
                    className={({ open }) =>
                        classNames(
                            open ? "fixed inset-0 z-40 overflow-y-none" : "",
                            "bg-white shadow-sm border-b border lg:static lg:overflow-y-none w-full "
                        )
                    }
                >
                    {({ open }) => (
                        <>
                            <div className="mx-auto   max-w-8xl px-4 sm:px-12 lg:px-12 w-full  ">
